...
// Unified Payment Gateway (UPI, Cards, NetBanking & Escrow Settlements)
...
export const paymentApi = {
  ...
  async createSplitBill(payload: { bookingRef: string; totalAmount: number; splitUsers: Array<{ phone: string; amount: number }> }): Promise<ApiResponse<any>> {
