...
export const SUPER_DASHBOARD_MODULES: OperatorModuleDetail[] = [
  ...
  // 10. Dhaba Operator Profile
  {
    id: "dhaba",
    name: "Haveli Grand Heritage Dhaba & Family Restaurant",
    categoryName: "Highway Dhaba Profile",
    icon: "Utensils",
  ...
  // 11. Restaurant / IRCTC e-Catering Profile
  {
    id: "restaurant",
    name: "Haldiram's Express & Satvik Rail Bhoj",
    categoryName: "Restaurant / e-Catering Profile",
    icon: "Utensils",
    tagline: "IRCTC Authorized Station e-Catering, Seat Delivery & Pure Jain Satvik Meals",
    badge: "IRCTC Authorized Partner",
    ...
    starRating: 4.89,
    totalReviews: 14200,
    operatingBase: "Kota Junction (KOTA), New Delhi (NDLS), Jaipur (JP), Mathura (MTJ)",
    supportContact: {
      phone: "+91 1800-111-139 (Rail Food Helpline)",
      email: "catering@haldiramsexpress.in",
      hours: "06:00 AM - 23:30 PM Station Platform Delivery Desk",
    },
    frontendAllowed: {
      profileSummary: "Premium station food partner delivering hygienic, steaming hot regional thalis, pure Jain food, and snacks directly to train berths across 120+ Indian Railway stations.",
      servicesOffered: [
        "Train Berth / Seat Direct Delivery",
        "Pure Jain Satvik Meals (No Onion, No Garlic)",
        "North & South Indian Deluxe Thalis",
        "Pre-Order Food with PNR Tracking",
      ],
      amenities: [
        "FSSAI 5-Star Hygiene Certified Kitchens",
        "Tamper-Proof Biodegradable Food Packaging",
        "Live Train Arrival & Berth Dispatch Sync",
        "Contactless Digital Payment or Cash on Delivery",
      ],
      policies: {
        cancellation: "Full refund if cancelled 2 hours before scheduled train arrival at delivery station.",
        checkInOrBoarding: "Food delivered directly to passenger berth 5 minutes after train halts.",
        luggageOrRules: "Hygienic cutlery and sanitizing wet wipes included in every meal kit.",
        refund: "Instant auto-refund to original payment mode if train is diverted or cancelled.",
      },
      publicPricing: {
        startingFrom: 180,
        priceUnit: "per meal / combo",
        taxPercentage: 5,
        platformFee: 0,
        discountOptions: ["RAILMEAL15 (15% OFF on Orders above ₹400)", "JAIN_SPECIAL (Free Sweet Dish)"],
      },
      bookingFeatures: [
        "Instant PNR Live Train Route Mapping",
        "Station & Delivery Window Selector",
        "Berth & Coach Delivery Detail Auto-Fill",
        "Live Delivery Boy Platform Tracking",
      ],
    },
    backendHiddenNeverDisplayed: {
      databaseTables: [
        "rail_ecatering_order_ledger",
        "station_vendor_fssai_vault",
        "irctc_gds_pnr_sync_master",
        "platform_delivery_partner_payouts",
      ],
      hiddenCredentialsAndKeys: [
        "IRCTC_ECATERING_OAUTH_TOKEN",
        "FOSCOS_FSSAI_VERIFY_KEY",
        "DELIVERY_DISPATCH_MQTT_SECRET",
      ],
      internalIds: ["ECATER_HALDIRAM_KOTA_01", "STATION_KOTA_PF1", "SETTLE_ACCT_HDFC_99182"],
      backendServices: [
        "IRCTC Real-Time PNR & Train Running Schedule Sync",
        "Station Kitchen Order Queue Throttling Engine",
        "Automated Delivery Agent Geofence Dispatcher",
      ],
      settlementEngineDetails: [
        "10% IRCTC & Platform aggregate commission deduction",
        "Daily T+1 settlement to station vendor bank accounts",
      ],
      securityAndAuditLogs: [
        "FSSAI daily temperature and hygiene audit checklist logs",
        "Encrypted passenger PNR and phone number tokens",
      ],
      zeroFrontendExposureGuarantee: "IRCTC internal API credentials, supplier commission percentages, and kitchen POS secrets remain strictly hidden.",
    },
    partnerListingPlans: {
      currentPlan: "Platinum",
      planStatus: "Active",
      monthlyFee: 14999,
      inventorySlotsUsed: 92,
      inventorySlotsTotal: 100,
      searchVisibilityBoost: "Top 1 Station Dining Partner across Western & Northern Railway",
      featuredBadging: true,
      leadAccess: "Direct High-Speed Rajdhani & Vande Bharat Passenger Orders",
      settlementCycle: "Daily T+1 Automated Bank Settlement",
      commissionRatePercentage: 8.5,
      grossBookingsThisMonth: 3890000,
      netPayoutThisMonth: 3559350,
      nextPayoutDate: "Tomorrow 08:00 AM IST",
    },
    mockInventoryItems: [
      {
        id: "dish_deluxe_thali",
        title: "Royal Maharaja Deluxe Thali (Paneer, Dal Makhani, 4 Roti, Rice, Gulab Jamun)",
        subtitle: "Delivered Hot to Coach & Berth with Cutlery & Hand Sanitizer",
        capacity: "Serves 1 Person",
        price: 290,
        availableCount: 200,
        amenityHighlights: ["Hot Delivery", "Pure Veg", "Sweet Included", "FSSAI 5-Star"],
      },
      {
        id: "dish_jain_khichdi",
        title: "Pure Jain Satvik Moong Dal Khichdi Bowl with Curd & Papad",
        subtitle: "Zero Onion, Zero Garlic • Prepared in Dedicated Satvik Kitchen",
        capacity: "Serves 1 Person",
        price: 180,
        availableCount: 120,
        amenityHighlights: ["100% Jain", "Digestive & Light", "Fresh Curd"],
      },
    ],
  },
  ...
  // 12. Pilgrimage / Yatra Operator Profile
  {
    ...
    starRating: 4.95,
    totalReviews: 8640,
    operatingBase: "Haridwar • Rishikesh • Dehradun • Varanasi • Katra • Ujjain",
    supportContact: {
      phone: "+91 135-2430-880",
      email: "yatra@divyadarshan.org.in",
      hours: "24/7 Pilgrimage Support & Helipad Desk",
    },
    frontendAllowed: {
      profileSummary: "Premier religious yatra operator providing helicopter charters, VIP temple darshan slots, senior-citizen assistance, pure Satvik meals, and sanitized accommodation.",
      servicesOffered: [
        "Char Dham Yatra Complete Circuit (Kedarnath, Badrinath, Gangotri, Yamunotri)",
        "Kedarnath Helicopter Shuttle & Priority Darshan Pass",
        "12 Jyotirlinga Darshan All-Inclusive Train & Luxury Bus Circuits",
        "Varanasi Kashi Vishwanath & Ganga Aarti VIP Boat Experience",
      ],
      amenities: [
        "VIP Priority Temple Darshan Passes",
        "100% Pure Satvik Vegetarian & Jain Meals",
        "Senior Citizen Wheelchair & Palki Assistance",
        "Helipad Transfers & Oxygen Cylinder Support",
        "Expert Sanskrit Scholars & Vedic Historian Guides",
        "Emergency Medical Evacuation Protocol",
      ],
      policies: {
        cancellation: "Full refund up to 15 days prior to yatra commencement. 50% between 7-14 days.",
        checkInOrBoarding: "Orientation briefing and biometric yatra card issuance at Haridwar Base Camp at 06:00 AM.",
        luggageOrRules: "1 lightweight duffel bag up to 10kg per pilgrim permitted for mountain sectors.",
        refund: "Processed automatically to payment source within 48 bank hours.",
      },
      publicPricing: {
        startingFrom: 34500,
        priceUnit: "per pilgrim (All-Inclusive Yatra Package)",
        taxPercentage: 5,
        platformFee: 0,
        discountOptions: ["SENIOR_PILGRIM (Flat ₹2,500 OFF for Senior Citizens)", "FAMILY_YATRA (10% OFF for Groups 4+)"],
      },
      bookingFeatures: [
        "Govt Devasthanam VIP Darshan Slot Booking",
        "Helicopter Shuttle Date & Weight Slot Selector",
        "Senior Citizen Palki / Pony Addon Selector",
        "Instant Biometric Yatra E-Pass with QR Code",
      ],
    },
    backendHiddenNeverDisplayed: {
      databaseTables: [
        "pilgrimage_yatra_master",
        "devasthanam_vip_slot_vault",
        "helipad_charter_quota_ledger",
        "operator_reconciliation_settlement_db",
      ],
      hiddenCredentialsAndKeys: [
        "UTTARAKHAND_TOURISM_DEVASHTHANAM_KEY",
        "DGCA_HELIPAD_SHUTTLE_SECRET",
        "PILGRIM_ESCROW_SETTLEMENT_TOKEN",
      ],
      internalIds: ["YATRA_DIVYA_DARSHAN_8819", "DEVASHTHANAM_SLOT_KD44", "SETTLE_ACCT_PNB_99182"],
      backendServices: [
        "Devasthanam Board VIP Darshan Pass Sync",
        "Helicopter Weight Balancer & Weather Go/No-Go Engine",
        "Pilgrim Medical Fitness & Oxygen Telemetry Sync",
      ],
      settlementEngineDetails: [
        "4.8% Standard OTA Commission on Religious Packages",
        "Milestone Payouts: 40% on booking lock, 60% upon Haridwar base camp check-in",
      ],
      securityAndAuditLogs: [
        "State Disaster Response Force (SDRF) connectivity logs",
        "Pilgrim biometric registration verification audits",
      ],
      zeroFrontendExposureGuarantee: "Devasthanam VIP token secrets, helicopter operator charter cost structures, and temple trust settlement details remain completely hidden.",
    },
    partnerListingPlans: {
      currentPlan: "Platinum",
      planStatus: "Active",
      ...
      searchVisibilityBoost: "Top 1 Featured Religious Tour Operator in India (+320% Inquiries)",
      featuredBadging: true,
      leadAccess: "Direct Temple Trusts & Group Pilgrim Leads Enabled",
      settlementCycle: "Milestone Payout (40% Advance, 60% on Base Camp Check-in)",
      commissionRatePercentage: 4.8,
      grossBookingsThisMonth: 6420000,
      netPayoutThisMonth: 6111840,
      nextPayoutDate: "Every Friday Yatra Settlement",
    },
    mockInventoryItems: [
      {
        id: "yatra_chardham_9d",
        title: "Char Dham Yatra Deluxe 9D/8N (Kedarnath, Badrinath, Gangotri, Yamunotri)",
        subtitle: "Luxury AC Coach • 3-Star Hotels • VIP Darshan • Helipad Transfer • Satvik Meals",
        capacity: "32 Pilgrims per Departure",
        price: 48500,
        availableCount: 8,
        amenityHighlights: ["VIP Darshan", "Satvik Food", "Helicopter", "Medical Team"],
      },
      {
        id: "yatra_kedarnath_heli",
        title: "Kedarnath Helicopter Same-Day VIP Darshan Express",
        subtitle: "Guptkashi / Phata Helipad • Return Chopper • Priority Temple Queue Pass",
        capacity: "6 Pax per Chopper Sortie",
        price: 18500,
        availableCount: 4,
        amenityHighlights: ["Helicopter", "VIP Line", "Pandit Guide", "Prasad Kit"],
      },
    ],
  },
  ...
  // 13. Luxury Resort & Spa Operator Profile
  {
    ...
    starRating: 4.97,
    totalReviews: 1920,
    operatingBase: "Mashobra Estate, Kufri Road, Shimla, Himachal Pradesh",
    supportContact: {
      phone: "+91 177-2890-440",
      email: "reservations@whisperingpines-resort.com",
      hours: "24/7 Front Desk & Concierge Butler",
    },
    frontendAllowed: {
      profileSummary: "25-acre luxury forest sanctuary nestled in cedar woods, featuring private heated Jacuzzis, Jiva Ayurvedic spa therapies, fine-dining restaurants, and panoramic mountain view decks.",
      servicesOffered: [
        "Presidential Cedar Chalets with Private Heated Jacuzzi",
        "Jiva Ayurvedic Spa & Himalayan Herbal Wellness Therapies",
        "Forest High-Tea & Candlelight Dine-in Experiences",
        "Guided Nature Trails, Birdwatching & Bonfire Evenings",
      ],
      amenities: [
        "Private Temperature-Controlled Jacuzzi & Fireplace",
        "Complimentary Gourmet Breakfast & Hi-Tea Buffet",
        "Ayurvedic Spa & Hydrotherapy Sessions",
        "High-Speed Starlink Satellite Wi-Fi Across Property",
        "Personal Butler Service & Valet EV Fast Charging",
      ],
      policies: {
        cancellation: "Free cancellation up to 72 hours prior to check-in date.",
        checkInOrBoarding: "Check-in: 02:00 PM • Check-out: 11:00 AM.",
        luggageOrRules: "Pet-friendly chalets available upon advance reservation.",
        refund: "Instant refund processed to source account within 24-48 hours.",
      },
      publicPricing: {
        startingFrom: 16500,
        priceUnit: "per night / villa (Breakfast Included)",
        taxPercentage: 12,
        platformFee: 0,
        discountOptions: ["SPA_GETAWAY (Free Couple Massage on 2N+ Stays)", "EARLY_BIRD (15% OFF 30 Days Prior)"],
      },
      bookingFeatures: [
        "Live Villa & Chalet 3D Virtual Tour Selector",
        "Ayurvedic Spa & Candlelight Dinner Addon Configurator",
        "Instant Digital Keyless Mobile Check-in Pass",
        "Butler WhatsApp Chat & Concierge Request Desk",
      ],
    },
    backendHiddenNeverDisplayed: {
      databaseTables: [
        "resort_property_inventory_master",
        "opera_pms_channel_bridge_ledger",
        "spa_therapist_slot_matrix",
        "resort_settlement_reconciliation_db",
      ],
      hiddenCredentialsAndKeys: [
        "ORACLE_OPERA_PMS_REST_KEY",
        "SITEMINDER_CHANNEL_SECRET",
        "RESORT_ESCROW_VAULT_KEY",
      ],
      internalIds: ["RESORT_SHM_WHISPERING_004", "OPERA_HOTEL_ID_HP991", "SETTLE_ACCT_AXIS_91802"],
      backendServices: [
        "Oracle Opera PMS 2-Way Channel Bridge",
        "Ayurvedic Spa & Wellness Slot Mutex",
        "Dynamic Weekend & Seasonal Yield Engine",
      ],
      settlementEngineDetails: [
        "8.0% Standard OTA Commission on Luxury Resort Stays",
        "Weekly Tuesday automated RTGS settlements",
      ],
      securityAndAuditLogs: [
        "Green Key Eco-Tourism compliance audit logs",
        "Encrypted guest folio & credit card tokenization ledger",
      ],
      zeroFrontendExposureGuarantee: "Opera PMS channel credentials, internal RevPAR yield algorithms, and property bank accounts remain strictly secluded on server-side microservices.",
    },
    partnerListingPlans: {
      currentPlan: "Platinum",
      planStatus: "Active",
      monthlyFee: 16999,
      inventorySlotsUsed: 38,
      inventorySlotsTotal: 42,
      searchVisibilityBoost: "Top 1 Featured Luxury Resort in Himachal Pradesh (+290% Inquiries)",
      featuredBadging: true,
      leadAccess: "Direct Luxury Leisure & Wellness Honeymoon Leads",
      settlementCycle: "Weekly Tuesday Automated Bank Settlement",
      commissionRatePercentage: 8.0,
      grossBookingsThisMonth: 4800000,
      netPayoutThisMonth: 4416000,
      nextPayoutDate: "Next Tuesday 10:00 AM IST",
    },
    mockInventoryItems: [
      {
        id: "resort_presidential_chalet",
        title: "Presidential Cedar Wooden Chalet with Heated Jacuzzi",
        subtitle: "1,200 sq.ft • Private Sundeck • Himalayan Valley View • Fireplace • Butler Service",
        capacity: "4 Adults or 2 Adults + 2 Kids",
        price: 16500,
        availableCount: 4,
        amenityHighlights: ["Private Jacuzzi", "Fireplace", "Breakfast", "High-Tea", "Spa Access"],
      },
      {
        id: "resort_forest_duplex",
        title: "Himalayan Forest Duplex Villa with Attic Bedroom",
        subtitle: "950 sq.ft • Pine Forest View • Heated Wooden Floors • Luxury Bathtub",
        capacity: "2 Adults + 2 Kids",
        price: 12500,
        availableCount: 6,
        amenityHighlights: ["Pine View", "Heated Floor", "Bathtub", "All Meals Plan"],
      },
    ],
  },

  // 14. B2B Wholesaler / Booking Operator Profile
  {
    id: "booking",
    name: "Bharat Global Travel Wholesalers & B2B Consolidator",
    categoryName: "Booking Operator / B2B Consolidator",
    icon: "Briefcase",
    tagline: "Wholesale Inventory, GDS Flight Consolidations & Sub-Agent White-Label Terminals",
    badge: "IATA & IATO Accredited National Consolidator",
    ...
    starRating: 4.96,
    totalReviews: 4850,
    operatingBase: "Barakhamba Road, Connaught Place, New Delhi • 1,450 Sub-Agent Hubs Nationwide",
    supportContact: {
      phone: "+91 11 4987-2200",
      email: "b2b@bharatglobaltravels.com",
      hours: "24/7 B2B Consolidator Helpdesk & Credit Top-up Desk",
    },
    frontendAllowed: {
      profileSummary: "National B2B travel consolidator providing wholesale airfares, hotel room blocks, Tatkal train quotas, and dynamic retail markup tools for travel agents across India.",
      servicesOffered: [
        "B2B Wholesale Airfares (Series Fares & Corporate NDC Buckets)",
        "Contracted 5-Star Hotel & Resort Room Blocks with 8.5% Net Margin",
        "White-Label Travel Agent Portal with Custom Branding & Invoicing",
        "Instant Credit Escrow & Daily Multi-Currency Wallet Top-ups",
      ],
      amenities: [
        "Instant Sub-Agent Wallet Credit & Zero-Latency PNR Ticketing",
        "Custom Retail Markup Engine (Configurable 2% to 15%)",
        "White-Label Client PDF Invoices with Sub-Agent Logo & GSTIN",
        "High-Throughput JSON REST API & GDS Direct Feeds",
        "Dedicated 24/7 Account Manager & Ticketing Desk",
      ],
      policies: {
        cancellation: "Automated GDS cancellation rules apply with instant agent wallet credit refunds.",
        checkInOrBoarding: "Instant PNR & E-Ticket issuance with sub-agent custom brand headers.",
        luggageOrRules: "Corporate baggage allowances (up to 25kg) included on contracted airline series.",
        refund: "Instant reversal to B2B credit escrow balance within 60 seconds.",
      },
      publicPricing: {
        startingFrom: 42000,
        priceUnit: "per wholesale package bundle (Net Rate before Agent Markup)",
        taxPercentage: 5,
        platformFee: 0,
        discountOptions: ["VOLUME_B2B (Additional 1.5% Margin on ₹10L+ Monthly Volume)", "ZERO_FEE_CREDIT (Free NEFT Top-up)"],
      },
      bookingFeatures: [
        "Real-Time Wholesale Inventory & GDS Availability Checker",
        "Dynamic Client Markup Calculator & Profit Margin Lock",
        "Instant White-Label PDF Ticket Generator with Sub-Agent Logo",
        "Sub-Agent Credit Balance & Overdraft Ledger Tracker",
      ],
    },
    backendHiddenNeverDisplayed: {
      databaseTables: [
        "b2b_subagent_escrow_master",
        "wholesale_contract_rate_matrix",
        "gds_amadeus_sabre_bridge_ledger",
        "subagent_commission_disbursement_db",
      ],
      hiddenCredentialsAndKeys: [
        "AMADEUS_B2B_CONSOLIDATOR_SECRET",
        "SABRE_DIRECT_CONNECT_KEY",
        "B2B_ESCROW_CREDIT_MUTEX_TOKEN",
      ],
      internalIds: ["B2B_CONSOL_BHARAT_9912", "SUBAGENT_NETWORK_1450", "SETTLE_ACCT_SBI_38920"],
      backendServices: [
        "Sub-Agent Rolling Escrow & Overdraft Mutex",
        "Dynamic Sub-Agent Retail Markup Injector",
        "White-Label PDF Branding & QR Generator",
      ],
      settlementEngineDetails: [
        "1.8% Platform wholesale take-rate",
        "Automated daily net credit ledger rebalancing and commission payout",
      ],
      securityAndAuditLogs: [
        "SOC2 Type II B2B financial transaction audit logs",
        "High-frequency API rate limit & DDoS defense logs",
      ],
      zeroFrontendExposureGuarantee: "GDS consolidator contract secrets, net base supplier costs, and sub-agent credit line terms remain strictly hidden from client-side DOM.",
    },
    partnerListingPlans: {
      currentPlan: "Enterprise",
      planStatus: "Active",
      monthlyFee: 24999,
      inventorySlotsUsed: 1450,
      inventorySlotsTotal: 2000,
      searchVisibilityBoost: "National Level B2B Consolidator Placement (+450% Agency Volume)",
      featuredBadging: true,
      leadAccess: "Unlimited Sub-Agent Network & White-Label Terminal Access",
      settlementCycle: "Daily Net Credit Ledger Settlement",
      commissionRatePercentage: 1.8,
      grossBookingsThisMonth: 24500000,
      netPayoutThisMonth: 24059000,
      nextPayoutDate: "Instant Daily Settlement Active",
    },
    mockInventoryItems: [
      {
        id: "b2b_goa_luxury_bundle",
        title: "Goa 4N Luxury Villa + Return Flights B2B Wholesale Bundle",
        subtitle: "4-Bedroom Private Pool Villa • Return Indigo Flights • Airport Transfers",
        capacity: "4 to 8 Pax",
        price: 42000,
        availableCount: 15,
        amenityHighlights: ["Wholesale Net Rate", "Flights Included", "Private Pool", "Custom Markup"],
      },
      {
        id: "b2b_kashmir_paradise_bundle",
        title: "Kashmir 5N Houseboat & Gulmarg Resort B2B Package",
        subtitle: "2N Srinagar Houseboat + 3N Gulmarg Resort + Shikara Ride + Meals",
        capacity: "2 to 4 Pax",
        price: 38000,
        availableCount: 12,
        amenityHighlights: ["Houseboat + Resort", "All Meals", "Shikara Ride", "8.5% Margin"],
      },
    ],
  },
];
