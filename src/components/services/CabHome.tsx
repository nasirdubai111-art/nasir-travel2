...
export function CabHome({
  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-300">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <button
                ...
                className="h-10 px-3.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 text-xs font-black flex items-center gap-1.5 transition-all shadow-md cursor-pointer"
              >
                ...
                <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                  <div className="space-y-2">
                    <div className="flex justify-between items-baseline">
                      <h3 className="font-bold text-[#172033] text-base group-hover:text-[#1B4332] transition-colors">{vehicle.categoryName}</h3>
                      <div className="text-right">
                        <span className="text-xs text-[#64748B]">Starts at</span>
                        <span className="text-base font-bold text-[#1B4332] ml-1">₹{vehicle.baseFarePerKm}/km</span>
                      </div>
                    </div>
                    <p className="text-xs text-[#64748B] font-medium">{vehicle.models}</p>

                    <div className="flex items-center gap-4 text-xs text-[#64748B] py-1 border-y border-[#E8E5DD]">
                      <span className="flex items-center gap-1 font-semibold text-[#172033]">
                        <Users className="w-3.5 h-3.5 text-[#2D6A4F]" /> {vehicle.capacitySeats} Seats
                      </span>
      ...
      <div className="bg-white rounded-2xl p-6 text-[#172033] grid grid-cols-1 md:grid-cols-3 gap-5 shadow-xs border border-[#E8E5DD]">
        <div className="flex items-start gap-3">
          <div className="p-3 rounded-xl bg-emerald-50 text-[#1B4332] border border-[#2D6A4F]/20">
