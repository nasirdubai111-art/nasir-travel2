          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <span className="p-2.5 rounded-xl bg-white/10 text-white border border-white/20">
                <Palmtree className="w-6 h-6 text-emerald-300" />
              </span>
              <div>
        ...
        <aside className="w-full lg:w-[256px] shrink-0 bg-white rounded-2xl border border-[#E8E5DD] shadow-xs p-5 space-y-5 text-[#172033]">
          ...
          <div className="pt-3 border-t border-[#E8E5DD] space-y-2">
            ...
            <select
              ...
              className="w-full h-10 bg-[#FAF9F5] border border-[#E8E5DD] rounded-xl px-3 text-xs font-medium text-[#172033] cursor-pointer"
            >
        ...
        <div className="flex-1 space-y-4 w-full">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-[#172033] flex items-center gap-2">
              ...
              <span className="text-xs bg-emerald-50 text-[#1B4332] px-2.5 py-0.5 rounded-full font-bold border border-[#2D6A4F]/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {filteredResorts.map((resort) => (
              <div
                key={resort.id}
                className="bg-white rounded-2xl border border-[#E8E5DD] overflow-hidden hover:border-[#2D6A4F] shadow-xs transition-all flex flex-col group"
              >
                {/* Image & Badges */}
                ...
                <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                  <div>
                    ...
                    <h3 className="text-base font-bold text-[#172033] mt-1 group-hover:text-[#1B4332] transition-colors">{resort.name}</h3>
                    <p className="text-xs text-[#64748B] mt-1 line-clamp-2">{resort.description}</p>

                    {/* Curated Package Highlights */}
                    <div className="mt-3 bg-[#FAF9F5] p-2.5 rounded-xl border border-[#E8E5DD] space-y-1">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {resort.curatedPackages.map((pkg) => (
                          <span
                            key={pkg.id}
                            className="px-2 py-0.5 rounded-md bg-white text-[#172033] border border-[#E8E5DD] text-[10px] font-medium"
                          >
                            {pkg.name}
                          </span>
                        ))}
                  ...
                  <div className="pt-3 border-t border-[#E8E5DD] flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="h-10 px-4 rounded-xl bg-[#1B4332] hover:bg-[#143225] text-white text-xs font-semibold shadow-xs transition-all flex items-center gap-1.5 cursor-pointer"
                    >
                      <span>View &amp; Book</span>
