...
interface NavbarProps {
  ...
  onOpenCalendarTimings?: (service?: any) => void;
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between overflow-x-auto no-scrollbar gap-4">
          ...
          <div className="flex items-center gap-2.5 sm:gap-4 text-[11px]">
            ...
            {onOpenCalendarTimings && (
              <>
                <button
                  onClick={() => onOpenCalendarTimings()}
                  className="flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-blue-500/20 text-blue-300 hover:bg-blue-500/30 border border-blue-400/30 font-bold transition-all cursor-pointer"
                  title="Universal Calendar &amp; Timings Engine across Flights, Trains, Buses, Hotels, Tours, Pilgrimage, Cabs &amp; Activities"
                >
                  <Calendar className="w-3.5 h-3.5 text-blue-400" />
                  <span>Calendar &amp; Timings</span>
                </button>
                <span className="text-slate-700">|</span>
              </>
            )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
        <div className="flex items-center justify-between gap-3 md:gap-6">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              onClick={onOpenCompare}
              className="hidden sm:flex items-center gap-1 px-2.5 py-1.5 rounded-xl border border-slate-200 text-xs font-bold text-slate-700 hover:bg-slate-100 hover:text-indigo-600 transition-colors cursor-pointer"
              title="Compare Modes"
            >
            ...
            <button
              onClick={onOpenTripPlanner}
              className="hidden md:flex items-center gap-1 px-2.5 py-1.5 rounded-xl border border-amber-200 bg-amber-50 text-xs font-bold text-amber-900 hover:bg-amber-100 transition-colors cursor-pointer"
              title="Plan Journey"
            >
